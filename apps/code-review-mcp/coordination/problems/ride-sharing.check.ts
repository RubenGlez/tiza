...
function show(label: string, plan: Record<string, unknown>, dynamic: boolean) {
  ...
  console.log(`${label}: ${r.pass ? "PASS" : "FAIL"}${r.violations.length ? " — " + r.violations.join("; ") : ""}`);
}

const valid = { "vehicle-1": { passengers: ["P1", "P2"] }, "vehicle-2": { passengers: ["P3", "P4"] }, "vehicle-3": { passengers: [] } };
const cross = { "vehicle-1": { passengers: ["P1", "P3"] }, "vehicle-2": { passengers: ["P2", "P4"] }, "vehicle-3": { passengers: [] } };
const dbl = { "vehicle-1": { passengers: ["P1", "P2"] }, "vehicle-2": { passengers: ["P1", "P3"] }, "vehicle-3": { passengers: ["P4"] } };
const split = { "vehicle-1": { passengers: ["P1", "P2"] }, "vehicle-2": { passengers: ["P3"] }, "vehicle-3": { passengers: ["P4"] } };
